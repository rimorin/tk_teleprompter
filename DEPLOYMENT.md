...
| ----------------------------------------------------------------------- | ------------------------------ | ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `DEEPGRAM_API_KEY`                                                      | a key for at least one service | —                              | Deepgram key (keep secret)                                                                                                                                               |
| `ASR_PROVIDER`                                                          | no                             | `deepgram`                     | Default speech service, `deepgram` or `assemblyai`. Presenters can choose any service that has a key                                                                     |
| `ASSEMBLYAI_API_KEY`                                                    | a key for at least one service | —                              | AssemblyAI key (keep secret): faster confirmed words, but browsers upload PCM (~8x the data of Opus). Opt out of model training in its dashboard for zero data retention |
