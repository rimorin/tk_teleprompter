...
| ----------------------------------------------------------------------- | ---------------------- | ------------------------------ | ------------------------------------------------------------------------------------------------------------------------- |
| `DEEPGRAM_API_KEY`                                                      | yes (default provider) | —                              | Deepgram key (keep secret)                                                                                                |
| `ASR_PROVIDER`                                                          | no                     | `deepgram`                     | `deepgram`, or `assemblyai` (faster confirmed words; browsers then upload PCM, ~8x the data of Opus)                      |
| `ASSEMBLYAI_API_KEY`                                                    | with `assemblyai`      | —                              | AssemblyAI key (keep secret). Opt out of model training in its dashboard for zero data retention                          |
